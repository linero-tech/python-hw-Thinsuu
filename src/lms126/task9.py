...
def task9():
    return """
    Show the user to put his/her bank card into the 
    ...
    Ask for the pincode of the user's bank card
    LET the user choose and click the following options:
    ...
    Ask the user to click Ok to confirm the amount
    Start ATM's internal process to withdraw money from card
    and convert to cash
    Notify the ATM user by blinking and pushing out cash 
    under the screen
    Push the bank card out
    """